...
// SB_QUEUE_COOLINGFAN_FANCMD_1_SIZE-1 elements.
#define SB_QUEUE_COOLINGFAN_FANCMD_1_SIZE 2
...
typedef struct sb_queue_CoolingFan_FanCmd_1 {
  ...
  // Queue of elements of type CoolingFan_FanCmd
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  CoolingFan_FanCmd elt[SB_QUEUE_COOLINGFAN_FANCMD_1_SIZE];

} sb_queue_CoolingFan_FanCmd_1_t;
...
typedef struct sb_queue_CoolingFan_FanCmd_1_Recv {
...
} sb_queue_CoolingFan_FanCmd_1_Recv_t;
...
// dropped since the last call to sb_queue_CoolingFan_FanCmd_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_CoolingFan_FanCmd_1_dequeue will fail to count a multiple of COUNTER_MAX in
