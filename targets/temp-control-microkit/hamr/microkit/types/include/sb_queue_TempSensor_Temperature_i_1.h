...
// SB_QUEUE_TEMPSENSOR_TEMPERATURE_I_1_SIZE-1 elements.
#define SB_QUEUE_TEMPSENSOR_TEMPERATURE_I_1_SIZE 2
...
typedef struct sb_queue_TempSensor_Temperature_i_1 {
  ...
  // Queue of elements of type TempSensor_Temperature_i
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  TempSensor_Temperature_i elt[SB_QUEUE_TEMPSENSOR_TEMPERATURE_I_1_SIZE];

} sb_queue_TempSensor_Temperature_i_1_t;
...
typedef struct sb_queue_TempSensor_Temperature_i_1_Recv {
...
} sb_queue_TempSensor_Temperature_i_1_Recv_t;
...
// dropped since the last call to sb_queue_TempSensor_Temperature_i_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_TempSensor_Temperature_i_1_dequeue will fail to count a multiple of COUNTER_MAX in
