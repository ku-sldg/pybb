...
mod tests {
  ...
  fn test_initialization() {
    crate::oiproc_operatorInterface_initialize();
  }
  ...
  fn test_compute() {
    ...
    crate::oiproc_operatorInterface_timeTriggered();
  }
}
...
mod GUMBOX_tests {
  ...
  testComputeCB_macro! {
    ...
    api_currentTemp: generators::TempSensor_Temperature_i_strategy_default()
  }
}
