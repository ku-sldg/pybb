...
use crate::bridge::oiproc_operatorInterface_GUMBOX as GUMBOX;
...
/** Contract-based test harness for the compute entry point
  ...
  */
pub fn testComputeCB(api_currentTemp: TempSensor::Temperature_i) -> HarnessResult
{
  // Initialize the app
  crate::oiproc_operatorInterface_initialize();
...
{
  return testComputeCB(container.api_currentTemp)
}
...
testComputeCB_macro {
  (
    ...
    proptest!{
      ...
      fn $test_name(
        (api_currentTemp)
            in ($api_currentTemp_strat)
      ) {
        match$crate::test::util::cb_apis::testComputeCB(api_currentTemp) {
          $crate::test::util::cb_apis::HarnessResult::RejectedPrecondition => {
