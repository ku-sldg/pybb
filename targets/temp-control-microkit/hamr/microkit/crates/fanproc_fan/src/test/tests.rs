...
mod tests {
  ...
  fn test_compute() {
    ...
    test_apis::put_fanCmd(CoolingFan::FanCmd::default());

    crate::fanproc_fan_timeTriggered();
  }
}
...
mod GUMBOX_tests {
  ...
  testComputeCB_macro! {
    ...
    api_fanCmd: generators::CoolingFan_FanCmd_strategy_default()
  }
}
