...
use crate::bridge::tsproc_tempSensor_GUMBOX as GUMBOX;
...
pub fn testInitializeCB() -> HarnessResult
{
  ...
  let api_currentTemp = get_currentTemp();

  // [CheckPost]: invoke the oracle function
  if !GUMBOX::initialize_IEP_Post (api_currentTemp) {
...
pub fn testComputeCB() -> HarnessResult
{
  ...
  // [CheckPost]: invoke the oracle function
  if !GUMBOX::compute_CEP_Post(api_currentTemp) {
