...
Acts II–VII share a consistent "<subject> drift:" naming (spec /
implementation / contract / baseline / axiom), with III/V paired as
...
### Act VI — Baseline drift: tampered evidence bundle, protocol, tooling: Scenes 6 + 7 (2.25 min)
...
### Act VII — Axiom drift: semantic measurement detects axioms and unsound proof techniques: Scenes 9 + 12 (2.75 min)
