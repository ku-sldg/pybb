...
<a id="d1"></a>
### D1 — scene 2 (benign): the ceiling edit
...
<a id="d2"></a>
### D2 — scene 2 (breaking): the `commands` restatement
...
<a id="d3"></a>
### D3 — scene 2 (breaking, blessed): the machine-adapted proof
...
<a id="d4"></a>
### D4 — scenes 3 and 5: the floor drift (also the laundered spec)
...
<a id="d5"></a>
### D5 — scene 3 (slice grain): benign note + violated slice
...
<a id="d6"></a>
### D6 — scene 4: the corrupted seed proof
...
<a id="d7"></a>
### D7 — scene 4: the machine-repaired proof
...
<a id="d8"></a>
### D8 — scene 5 beat 1: one flipped byte of signed evidence
...
<a id="d9"></a>
### D9 — scene 5 beat 2: one hand-edited installed golden
...
<a id="d10"></a>
### D10 — scene 6: the functionality-preserving wrapper edit
...
<a id="d11"></a>
### D11 — scene 7 beat 1: the deleted audit query
...
<a id="d12"></a>
### D12 — scene 7 beat 2: the substituted audit query
...
<a id="d13"></a>
### D13 — scene 8: the behavior inversion
